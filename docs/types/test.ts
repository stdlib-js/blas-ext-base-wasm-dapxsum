...
// Attached to the main export is a `main` method which returns a number...
{
	...
	dapxsum.main( x.length, 5.0, x, 1 ); // $ExpectType number
}
...
// The compiler throws an error if the `main` method is provided a first argument which is not a number...
{
	...
	dapxsum.main( '10', 5.0, x, 1 ); // $ExpectError
	dapxsum.main( true, 5.0, x, 1 ); // $ExpectError
	dapxsum.main( false, 5.0, x, 1 ); // $ExpectError
	dapxsum.main( null, 5.0, x, 1 ); // $ExpectError
	dapxsum.main( undefined, 5.0, x, 1 ); // $ExpectError
	dapxsum.main( [], 5.0, x, 1 ); // $ExpectError
	dapxsum.main( {}, 5.0, x, 1 ); // $ExpectError
	dapxsum.main( ( x: number ): number => x, 5.0, x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a second argument which is not a number...
{
	...
	dapxsum.main( x.length, '10', x, 1 ); // $ExpectError
	dapxsum.main( x.length, true, x, 1 ); // $ExpectError
	dapxsum.main( x.length, false, x, 1 ); // $ExpectError
	dapxsum.main( x.length, null, x, 1 ); // $ExpectError
	dapxsum.main( x.length, undefined, x, 1 ); // $ExpectError
	dapxsum.main( x.length, [], x, 1 ); // $ExpectError
	dapxsum.main( x.length, {}, x, 1 ); // $ExpectError
	dapxsum.main( x.length, ( x: number ): number => x, x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a third argument which is not a Float64Array...
{
	...
	dapxsum.main( x.length, 5.0, 10, 1 ); // $ExpectError
	dapxsum.main( x.length, 5.0, '10', 1 ); // $ExpectError
	dapxsum.main( x.length, 5.0, true, 1 ); // $ExpectError
	dapxsum.main( x.length, 5.0, false, 1 ); // $ExpectError
	dapxsum.main( x.length, 5.0, null, 1 ); // $ExpectError
	dapxsum.main( x.length, 5.0, undefined, 1 ); // $ExpectError
	dapxsum.main( x.length, 5.0, [], 1 ); // $ExpectError
	dapxsum.main( x.length, 5.0, {}, 1 ); // $ExpectError
	dapxsum.main( x.length, 5.0, ( x: number ): number => x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a fourth argument which is not a number...
{
	...
	dapxsum.main( x.length, 5.0, x, '10' ); // $ExpectError
	dapxsum.main( x.length, 5.0, x, true ); // $ExpectError
	dapxsum.main( x.length, 5.0, x, false ); // $ExpectError
	dapxsum.main( x.length, 5.0, x, null ); // $ExpectError
	dapxsum.main( x.length, 5.0, x, undefined ); // $ExpectError
	dapxsum.main( x.length, 5.0, x, [] ); // $ExpectError
	dapxsum.main( x.length, 5.0, x, {} ); // $ExpectError
	dapxsum.main( x.length, 5.0, x, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided an unsupported number of arguments...
{
	...
	dapxsum.main(); // $ExpectError
	dapxsum.main( x.length ); // $ExpectError
	dapxsum.main( x.length, x ); // $ExpectError
	dapxsum.main( x.length, x, 1 ); // $ExpectError
	dapxsum.main( x.length, x, 1, 10, 2 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided an unsupported number of arguments...
{
	...
	dapxsum.ndarray( x.length, x ); // $ExpectError
	dapxsum.ndarray( x.length, x, 1 ); // $ExpectError
	dapxsum.ndarray( x.length, x, 1, 0 ); // $ExpectError
	dapxsum.ndarray( x.length, x, 1, 0, 10, 2 ); // $ExpectError
}
...
// Attached to the main export is a `Module` constructor which returns a module...
{
	...
	dapxsum.Module( mem ); // $ExpectType Module
}

// The compiler throws an error if the `Module` constructor is not provided a WebAssembly memory instance...
{
	dapxsum.Module( '10' ); // $ExpectError
	dapxsum.Module( true ); // $ExpectError
	dapxsum.Module( false ); // $ExpectError
	dapxsum.Module( null ); // $ExpectError
	dapxsum.Module( undefined ); // $ExpectError
	dapxsum.Module( [] ); // $ExpectError
	dapxsum.Module( {} ); // $ExpectError
	dapxsum.Module( ( x: number ): number => x ); // $ExpectError
}
